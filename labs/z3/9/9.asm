;================================================================= 
title	Програма 9 (типа COM)		;имя текстового файла  -  z3_pr9.asm
;------------------------------------------------------------------------------------------------------------
...
;------------------------------------------------------------------------------------------------------------
																;Определения
FSYM		equ		80h											;код первого символа
NSYM		equ		80h											;количество выводимых символов
;------------------------------------------------------------------------------------------------------------
myproc	proc													;начало процедуры по имени myproc

																;Основные фрагменты программы
																;Заполним строку кодами символов
			mov	CX,NSYM											;Число символов в счетчик цикла
			mov	AL,FSYM											;Код первого символа (пробела) в AL
